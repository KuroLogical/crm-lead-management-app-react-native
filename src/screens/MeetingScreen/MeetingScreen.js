...
import { View, Text, ScrollView, Image, TouchableOpacity, Appearance } from 'react-native';
...
const MeetingScreen = (props) => {
  ...
  const tabs = [t("Today_meetings"), t("Meetings_details")];
  const data = [
  ...
  const [selectedTab, setSelectedTab] = useState('Today meetings');
