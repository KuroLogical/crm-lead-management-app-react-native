...
import { DarkLightTheme, Spacing } from '../../../components';
import { SH, SF, Colors, Fonts } from '../../../utils';
...
const LoginScreen = () => {
    ...
    return (
        <View style={LoginStyles.container}>
            <Image source={images.loginLogo} resizeMode="center" style={LoginStyles.logo} />
            <Text style={LoginStyles.title}>CRM</Text>
            <Spacing space={40} />
